...
class Ad
{
    ...
    /**
     * Permet d'obtenir un tableau des jours qui ne sont pas dispo pour cette annonces
     *
    ...
    public function getNotAvailableDays(){
        ...
        foreach($this->bookings as $booking){
            //calculer les jours qui se trouvent entre la date d'arriver et le départ
            $resultat = range(
